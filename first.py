...
com = """INSERT INTO PRISONER VALUES ('P0','VARSHA','M','221, CLOVERFIELD LANE','FIRST DEGREE','2000-01-23','2017-01-23','FEMALE',6000,'QQ','4444444444','1');"""
crsr.execute(com)

com = """INSERT INTO PRISONER VALUES ('P1','PRATIKSHA','P','TIMES SQUARE, NY','SECOND DEGREE','1998-03-20','2017-03-23','FEMALE',9000,'JJ','4444489023','0');"""
crsr.execute(com)

com = """INSERT INTO PRISONER VALUES ('P2','HARMFUL','HARRY','34, AVENUE BOULEVARD','THIRD DEGREE','2001-02-30','2015-03-17','MALE',4000,'AA','4444444444','2');"""
crsr.execute(com)

com = """INSERT INTO PRISONER VALUES ('P3','HARMLESS','INTRUDER','89, LINKIN STREET','FIRST DEGREE','2002-07-30','2018-10-31','FEMALE',8000,'BB','5673982349','3');"""
crsr.execute(com)

com = """INSERT INTO PRISONER VALUES ('P4','BELLA','SWAN','100, FORKS, SEATTLE','FIRST DEGREE','1997-04-19','2018-10-11','FEMALE',3000,'II','4444489023','4');"""
crsr.execute(com)

com = """INSERT INTO PRISONER VALUES ('P5','JENKIN','JACOB','20, POWERHOUSE LANE','SECOND DEGREE','1980-05-19','2014-11-09','MALE',6000,'CC','5673982349','0');"""
crsr.execute(com)

com = """INSERT INTO PRISONER VALUES ('P6','URSULA','BUFFAY','17, MANSFIELD PARK','THIRD DEGREE','1988-09-29','2012-11-10','FEMALE',2000,'MM','9834782310','2');"""
crsr.execute(com)

com = """INSERT INTO PRISONER VALUES ('P7','RACHEL','GREENE','10, FRONTING LANE','SECOND DEGREE','1978-12-31','2014-12-31','NONE',2000,'HH','9834782310','3');"""
crsr.execute(com)
